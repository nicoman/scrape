...
class LivingSocialSpider(BaseSpider):
    """Spider for regulary updated livingsocial.com site, San Francisco Page"""
    ...
    item_fields = {
        ...
        'original_price': './/a/div[@class="deal-prices"]/div[@class="deal-strikethrough-price"]/div[@class="strikethrough-wraper"]/text()',
